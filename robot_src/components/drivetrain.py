...
class FROGDrive(DifferentialDrive):
    ...
    ENCODER_TICKS_PER_REV = 4096  # halved from last year
    MAX_VELOCITY = 3000  # halved from last year
    WHEEL_DIAMETER = 6
    TICKS_PER_INCH = ENCODER_TICKS_PER_REV / (math.pi * WHEEL_DIAMETER)
    TICKS_PER_ANGLE = 8000 / 180  # in degrees - halved from last year
    ...
    MM_ACCELERATION = 1000
    MM_CRUISE_VELOCITY = 2000
